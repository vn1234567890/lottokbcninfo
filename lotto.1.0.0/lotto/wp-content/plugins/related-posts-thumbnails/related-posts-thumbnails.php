...
class RelatedPostsThumbnails {
	...
	function get_thumbnails( $show_top = false ) { // Retrieve Related Posts HTML for output
		...
		if ($relpoststh_output_style == 'list') {
			...
			$output.='<style type="text/css">.plugin_posts_thumbnails a div { width: 186px !important;backgrouns-size:cover; }</style>';
			$output .= '<div style="clear: both"></div><div class="plugin_posts_thumbnails">';

...
<?php 	$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
	...
	?> 
		...
		<div class="reviewheader">
			...
			echo '<a class="approved_box" style="cursor: pointer; color: #ffffff; display: block; position: absolute; top: 10px;" onclick="scrollToElement(\'#respond\');">Read and Submit<br />User Review</a>';
			}
			?></div>
		</div>
		...
		<div class="lottery_review_left">
			...
			$screenshot = get_post_meta( $assigned_review_to, 'lottery_sites_screenshot', true );
		...
		<a class="playnow" target="_blank" href="<?php echo esc_html( get_post_meta( $assigned_review_to, 'lottery_sites_afflink', true ) ); ?>" rel="nofollow"></a>
		</div>
		...
		<?php $bonusinfo = esc_html( get_post_meta( $assigned_review_to, 'lottery_sites_bonusinfo', true ) ); if (!empty($bonusinfo)) { ?>
		
		<tr class="review_row">

		<td class="review_title"><span class="v-icon2">Bonus info:</span></td>

		<td class="review_postmeta" style="line-height: normal;"><?php echo $bonusinfo; ?></td>

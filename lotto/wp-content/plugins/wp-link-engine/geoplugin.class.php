...
if(!class_exists("geoPlugin")) {
	...
	function fetch($host) {
		...
		if ( function_exists('curl_init') ) {
            ...
            if(!is_serialized($response)) {
                trigger_error("geoPlugin class Error: This IP address has been temporarily blacklisted for high request load or the data server is currently offline. Contact support to get past this.", E_USER_NOTICE);
            }
			curl_close ($ch);
	...
	function latlong($lat, $long, $limit=null) {
		...
		$host = "http://www.geoplugin.net/extras/nearby.gp?lat=" . $lat . "&long=" . $long;

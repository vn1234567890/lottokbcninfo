	...
	class BhittaniPlugin_kkStarRatings extends BhittaniPlugin
	{
		...
		*/
		...
		public function markup($id=false)
		{
            ...
            /*
            switch ($rating_title) {
                case in_category('Lottery Ticket Sellers Exposed'):
                    $rating_title ="How Would You Rate This Lotto Agent?";
                    break;
                case in_category('Lottery Syndicates Exposed'):
                    $rating_title ="How Would You Rate This Lottery Syndicate?";
                    break;
                case in_category('Lottery Apps & Software Exposed'):
                    $rating_title ="How Would You Rate This Lottery Software?";
                    break;
            }*/

           if (in_category('Lottery Ticket Sellers Exposed')){
               $rating_title ="How Would You Rate This Lotto Agent?";
           }
            if(in_category('Lottery Syndicates Exposed')){
               $rating_title ="How Would You Rate This Lottery Syndicate?";
            }
            if(in_category('Lottery Exposed')){
                $rating_title ="How Would You Rate This Lottery?";
            }
            if(in_category('lottery-software-exposed')){
                $rating_title ="How Would You Rate This Lottery Software?";
            }
			$markup = '
			<div class="raitng_header">'.$rating_title.'</div>

<?php
 ...
 /*Template Name: Lottery Reviews - Single
...
get_header(); ?>
	  ...
	  <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); $assigned_to = get_post_meta( get_the_ID(), 'lottery_reviews_assign', true ); $themedir = get_stylesheet_directory_uri();?>
		...
		<div class="lottery_review_left">
			...
			$has_postimage = get_the_post_thumbnail(get_the_ID(), array( 220, 165 ));

	...
	<div class="sidebar-block sidebar-block-bg" style="height: 300px;">
	<div class="sidebar-block-header arrow-down">Top Lottery Jackpots</div>
	<?php echo do_shortcode('[top3jps]'); ?>
	</div>
	
	<div class="sidebar-block sidebar-block-bg" style="height: 240px;">
	<div class="sidebar-block-header">Approved Lottery Agents</div>
	<?php
...
<?php } ?>
 ...
 <?php 
        ...
        <div class="sidebar-block sidebar-block-bg">
            <div class="sidebar-block-header">Global Lotteries Exposed</div>
            <?php
            if ( has_nav_menu( 'sidebar-menu' ) ) {
                wp_nav_menu( array( 'theme_location' => 'sidebar-menu') );
            }
            ?>
          <button class="reportBtn">Report News</button>
            <div class="transBg"> <div class="report"> <?php echo do_shortcode('[contact-form-7 id="6473" title="Report News"]'); ?></div>
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function(){
                        ...
                        $( 'div.transBg span.close' ).click(function() {
                            $('div.transBg').hide();
                        });
                    });
                </script>

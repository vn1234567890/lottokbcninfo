...
jQuery(function($){
	...
	jQuery("#comments_wrapper ul.children li").show();
...
$comment_args = array(
  'id_form'           => 'commentform',
  'id_submit'         => 'submit',
  'title_reply'       => __( '<h2>Have something to say?</h2>' ),
  'title_reply_to'    => __( 'Leave a Reply to %s' ),
  'cancel_reply_link' => __( 'Cancel Reply' ),
  'label_submit'      => __( '' ),

  'comment_field' =>  '<p class="h"><label for="comment">' . _x( 'Comment:', 'noun' ) .
  ...
  'fields' => apply_filters( 'comment_form_default_fields', array(
    ...
    'email' =>
      '<p class="h"><label for="email">' . __( 'Email:', 'domainreference' ) . '</label> ' .
      '<input class="required" id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) .
      '" size="30"' . $aria_req . ' /></p>',
